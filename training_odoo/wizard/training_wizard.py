...
class TrainingWizard(models.TransientModel):
    ...
    attendee_ids = fields.Many2many('training.attendee', string='Peserta', required=True)
    session_ids = fields.Many2many('training.session', string="Sesi", default=_default_sesi, required=True)
